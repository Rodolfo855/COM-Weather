...
class ZoomAnimationViewController: UIViewController {
    var headline: String? { didSet { titleLabel.text = headline } }
    var subheadline: String? { didSet { statusLabel.text = subheadline } }
    var imageName: String?
    var humidity: String?
    var pressure: String?
    var detailedDescription: String? { didSet { descriptionLabel.text = detailedDescription } }
    ...
    override func viewDidLoad() {
        ...
        setupLayout()
        updateUI()
        [titleLabel, statusLabel, statsLabel, descriptionLabel].forEach { $0.alpha = 1.0 }
    }
    ...
    private func setupBlurBackground() {
        let style: UIBlurEffect.Style = traitCollection.userInterfaceStyle == .dark ? .systemChromeMaterialDark : .systemChromeMaterialLight
